...
public class OpCode {
    ...
    public static final OpCode ADDI = new OpCode(AddressingType.IMMEDIATE, "ADDI", 0x01);
    public static final OpCode SUBI = new OpCode(AddressingType.IMMEDIATE, "SUBI", 0x02);
    public static final OpCode MULTI = new OpCode(AddressingType.IMMEDIATE, "MULTI", 0x03);
